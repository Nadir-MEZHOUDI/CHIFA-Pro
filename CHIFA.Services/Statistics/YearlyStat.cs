...
public class YearlyStat
{
    ...
    [DataMember(Order = 8)] public decimal? MontantAss { get; init; }
    [DataMember(Order = 9)] public decimal? MontantOff { get; init; }
    [DataMember(Order = 10)] public int Assureis { get; init; }
    [DataMember(Order = 11)] public int Beneficiaires { get; init; }
